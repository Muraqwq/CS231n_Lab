...
def simclr_loss_naive(out_left, out_right, tau):
    ...
    for k in range(N):  # loop through each positive pair (k, k+N)
        ...
        ll = -((sim(z_k, z_k_N) / tau).exp() / (sims_k / tau).exp().sum()).log()
        lr = -((sim(z_k_N, z_k) / tau).exp() / (sims_k_N / tau).exp().sum()).log()
...
def sim_positive_pairs(out_left, out_right):
    ...
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    linalg_l = out_left / torch.linalg.norm(out_left, dim=1, keepdim=True)
    linalg_r = out_right/ torch.linalg.norm(out_right, dim=1, keepdim=True)
    pos_pairs = (linalg_l * linalg_r).sum(dim=1, keepdim=True)
    # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
...
def compute_sim_matrix(out):
    ...
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    linalg = out / torch.linalg.norm(out, dim=1, keepdim=True)
    sim_matrix =  linalg @ linalg.T
    # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
...
def simclr_loss_vectorized(out_left, out_right, tau, device='cuda'):
    ...
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    sim_pos_pairs = torch.concat([sim_positive_pairs(out_left, out_right),sim_positive_pairs(out_right, out_left)])
    # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    
    # Step 3: Compute the numerator value for all augmented samples.
    numerator = (sim_pos_pairs / tau).exp()
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
